...
class TestRunner:
    ...
    def test_experiments(self):
        ...
        assert_equals(self.field_counts('experiments_full/data.csv'), [393] * 3)
    ...
    def test_individual_stages(self):
        table = [
            ...
            ['present_past_future', 3, 62],
            ['seasons_of_year', 3, 80],
            ['parts_of_day', 3, 48],
            ['days_of_week', 3, 125],
            ['timeline', 2, 55],
    ...
    def test_individual_stages_long(self):
        table = [
            ['present_past_future', 7, 18],
            ['seasons_of_year', 9, 19],
            ['parts_of_day', 7, 14],
            ['days_of_week', 15, 18],
            ['timeline', 10, 7],
        ]
