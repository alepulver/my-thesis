...
class TestStageData:
    ...
    def test_present_past_future(self):
        ...
        assert_equals(result, [
            16.061908333987468, 93.72683470581782, -174.448217568532,
    ...
    def test_days_of_week(self):
        ...
        assert_equals(result, [
            174.4955588533465, 118.5466463117858, -105.84330949295078,
            ...
            -173.1604736510121, 128.91742940177008, 176.7777663708909,
